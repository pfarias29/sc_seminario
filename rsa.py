...
def main():
    ...
    cyphertext = rsa_encrypt(message.encode() , public_key)

    decrypted_message = rsa_decrypt(cyphertext, private_key).decode()

    file_signature = sign_file(message_file, private_key)
    pdf_file_signature = sign_file(pdf_file, private_key)

    verified = verify_file(message_file, file_signature, public_key)
    verified_pdf = verify_file(pdf_file, pdf_file_signature, public_key)
